...
<body>
    <div class="container bg-white p-5 shadow-sm rounded">
        ...
        <ul>
            ...
            <li><strong>Website</strong> refers to Sushi Sapporo, accessible from https://www.sushisapporo.com</li>
        ...
        <h2>Placing Orders for Food</h2>
        <p>By placing an Order for Food through the Service, You warrant that You are of legal age and are legally capable of entering into binding contracts.</p>
        ...
        By submitting such information, You grant us the right to provide the information to payment processing third parties for purposes of facilitating the completion of Your Order.</p>

        <h2>Marketing Communications Consent</h2>
        <p>By placing an order from <strong>Sushi Sapporo</strong>, you acknowledge that our ordering technology is provided by Beyond Menu, and you consent to receive marketing communications from Beyond Menu. These communications may include SMS, email, or push notifications, and can be related directly to our restaurant or about Beyond Menu's platform in general. You can opt out of receiving these communications at any time by following the unsubscribe link in the messages or as outlined in our Privacy Policy</p>
        ...
        <ul>
            ...
            <li>Errors in the description or prices for Food</li>
            <li>Errors in Your Order</li>
        </ul>
        <p>We reserve the right to refuse or cancel Your Order if fraud or an unauthorized or illegal transaction is suspected.</p>

        <h2>Availability, Errors and Inaccuracies</h2>
        <p>We are constantly updating Our offerings of menu items on the Service. The Food available on Our Service may be mispriced, described inaccurately, or unavailable, and We may experience delays in updating information regarding our menu items on the Service and in Our advertising on other websites.
        ...
        <h2>Payments</h2>
        <p>All menu items purchased are subject to a one-time payment. Payment can be made through various payment methods we have available, such as Visa, MasterCard, Affinity Card, American Express cards or online payment methods (PayPal, for example).
        Payment cards (credit cards or debit cards) are subject to validation checks and authorization by Your card issuer. If we do not receive the required authorization, We will not be liable for any delay or non-delivery of Your Order.</p>

        <h2>Intellectual Property</h2>
        <p>The Service and its original content, features and functionality are and will remain the exclusive property of the Company.
        The Service is protected by copyright, trademark, and other laws of the Country.
        Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of the Company.
        Online ordering technology is provided by Beyond Menu. Use of their technology is covered through their terms and conditions which can be found here: https://www.beyondmenu.com/policy.aspx</p>
        ...
        Without limiting the foregoing, the Company does not make any representation or warranty of any kind, express or implied:
        ...
        <h2>Governing Law</h2>
        <p>The laws of the Country and the State of , excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
