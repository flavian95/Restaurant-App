...
<head>
    ...
    <title>Cookies Policy - Sushi Sapporo</title>
...
<body>
    <div class="container bg-white p-5 shadow-sm rounded">
        ...
        <ul>
            <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sushi Sapporo</li>
            ...
            <li>Website refers to Sushi Sapporo, accessible from www.sushisapporo.com</li>
        </ul> 
        ...
        <ul>
            ...
            <li>
                <p>For the Internet Explorer web browser, please visit this page from Microsoft:</p>
                <p>http://support.microsoft.com/kb/278835</p>
            </li>
            <li>
                <p>For the Firefox web browser, please visit this page from Mozilla:</p>
            ...
            <li>
                ...
                <p>https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac</p>
            </li>
        </ul>
